...
from langchain.embeddings import OpenAIEmbeddings, SelfHostedHuggingFaceInstructEmbeddings
...
def get_vectorstore(text_chunks):
    ...
    embeddings = SelfHostedHuggingFaceEmbeddings(model_name="hkunlp/instructor-xl")
